...
// where  getCallGraph(start, end, "list_insert", end.getName()) or hasPath(start, end,"list_insert")
...
from Function start, Function end, Location start_loc, Location end_loc
where   start.hasName("list_insert") and ( getCallGraph(start, end, "list_insert", end.getName())  or hasPath(start, end,"list_insert") ) and  start_loc = start.getADeclarationEntry().getBlock().getLocation() and end_loc = end.getLocation()
