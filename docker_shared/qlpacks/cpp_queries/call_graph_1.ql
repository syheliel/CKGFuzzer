...
// where  getCallGraph(start, end, "QualifyPath", end.getName()) or hasPath(start, end,"QualifyPath")
...
from Function start, Function end, Location start_loc, Location end_loc
where   start.hasName("QualifyPath") and ( getCallGraph(start, end, "QualifyPath", end.getName())  or hasPath(start, end,"QualifyPath") ) and  start_loc = start.getADeclarationEntry().getBlock().getLocation() and end_loc = end.getLocation()
