...
// where  getCallGraph(start, end, "SubstituteFile", end.getName()) or hasPath(start, end,"SubstituteFile")
...
from Function start, Function end, Location start_loc, Location end_loc
where   start.hasName("SubstituteFile") and ( getCallGraph(start, end, "SubstituteFile", end.getName())  or hasPath(start, end,"SubstituteFile") ) and  start_loc = start.getADeclarationEntry().getBlock().getLocation() and end_loc = end.getLocation()
