...
// where  getCallGraph(start, end, "ENTRY_FNC", end.getName()) or hasPath(start, end,"ENTRY_FNC")
...
from Function start, Function end, Location start_loc, Location end_loc
where   start.hasName("ENTRY_FNC") and ( getCallGraph(start, end, "ENTRY_FNC", end.getName())  or hasPath(start, end,"ENTRY_FNC") ) and  start_loc = start.getADeclarationEntry().getBlock().getLocation() and end_loc = end.getLocation()
