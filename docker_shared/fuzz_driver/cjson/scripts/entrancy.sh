...
echo "cp -rf /generated_fuzzer/fuzz_driver/${project_name}/compilation_pass_rag/${fuzz_driver_file} $SRC/${project_name}/fuzzing/${fuzz_driver_file}" #>> /generated_fuzzer/fuzz_driver/${project_name}/scripts/a.txt
cp -rf /generated_fuzzer/fuzz_driver/${project_name}/compilation_pass_rag/${fuzz_driver_file} $SRC/${project_name}/fuzzing/${fuzz_driver_file}
