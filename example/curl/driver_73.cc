...
extern "C" int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size) {
    ...
    // Set MIME data using curl_mime_data
    ...
    // Set MIME data using curl_mime_data_cb
    ...
    // Set MIME subparts (not implemented, but call it to ensure coverage)
    ...
    // Set MIME headers (not implemented, but call it to ensure coverage)
